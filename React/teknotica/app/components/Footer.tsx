...
export default function Footer() {
    ...
    return (
        <footer className="bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 py-12">
            <div className="max-w-6xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    {/* Columna 1: Sobre Teknotica */}
                    <div>
                        <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-4">Teknotica</h3>
                    ...
                    <div>
                        <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-4">Servicios</h3>
                    ...
                    {/* Columna 3: Contacto */}
                    <div>
                        <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-4">Contacto</h3>
                ...
                {/* Línea divisoria */}
                <div className="border-t border-gray-200 dark:border-gray-800 pt-6 text-center text-sm text-gray-600 dark:text-gray-500">
